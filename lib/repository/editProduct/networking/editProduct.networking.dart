...
class EditProductNetworking {
  static const String urlENDPOINT = "http://cashbes.com/photography/apis/trader_edit_product";
  final client = http.Client();

  late EditProductModel editProductModel;

  Future<EditProductModel> editProducts({
        required String id,
    ...
    try {
      ...
      request.fields['spec_values_edited'] = spec_values_edited;
      ...
      requestResponse.stream.transform(utf8.decoder).listen((value) {
        ...
        if (requestResponse.statusCode == 200) {
          editProductModel = EditProductModel.fromJson(jsonResponse);
        }
      });
